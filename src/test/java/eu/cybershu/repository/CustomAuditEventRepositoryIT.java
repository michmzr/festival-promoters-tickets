...
import eu.cybershu.config.audit.AuditEventConverter;
import eu.cybershu.domain.PersistentAuditEvent;
...
import static eu.cybershu.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
